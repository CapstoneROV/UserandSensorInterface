...
void waypoint_nav_plugin::WaypointFrame::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        WaypointFrame *_t = static_cast<WaypointFrame *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject waypoint_nav_plugin::WaypointFrame::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_waypoint_nav_plugin__WaypointFrame.data,
      qt_meta_data_waypoint_nav_plugin__WaypointFrame,  qt_static_metacall, nullptr, nullptr}
};

...
get_filename_component(_filename "/home/linux/catkin_ws/src/freefloating_gazebo/srv/ControlType.srv" NAME_WE)
add_custom_target(_freefloating_gazebo_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "freefloating_gazebo" "/home/linux/catkin_ws/src/freefloating_gazebo/srv/ControlType.srv" ""
)
...
_generate_srv_cpp(freefloating_gazebo
  "/home/linux/catkin_ws/src/freefloating_gazebo/srv/ControlType.srv"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/freefloating_gazebo)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/freefloating_gazebo\")")
  # install generated code
  install(
